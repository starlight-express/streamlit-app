...
# Set page title
st.set_page_config(page_title="Astypalea Energy Dashboard", layout="wide")
...
st.title("Astypalea Energy Dashboard")

# Link to Lottie animation
lottie_island = load_lottieurl("https://assets9.lottiefiles.com/packages/lf20_x91No1YtUL.json")
st_lottie(lottie_island, speed=1, height=250, key="lottie_island")

row0_spacer1, row0_1, row0_spacer2, row0_2, row0_spacer3 = st.columns(
    (0.1, 2, 0.2, 1, 0.1)
)

row0_1.title("Astypalea, Greece")
...
with row2_1:
    ...
    lottie_energy = load_lottieurl("https://assets6.lottiefiles.com/packages/lf20_owazicxl.json")
    st_lottie(lottie_energy, speed=1, height=250, key="lottie_energy")
